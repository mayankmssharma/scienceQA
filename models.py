...
class ContrastiveModel(nn.Module):
    ...
    def forward(self, questions, choices, labels):
        ...
        question_embed = self.get_embeddings(questions, max_length=50)
        question_embed = nn.ReLU()(self.scorer(question_embed))

        choice_embed = self.get_embeddings(choices, max_length=5)
        choice_embed = nn.ReLU()(self.scorer(choice_embed))
